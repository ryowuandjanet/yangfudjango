...
SECRET_KEY = '&i1b_q#s^ktdc5c7kri-25moy811_7ba%zx_y+c=b-z$&flmi='
...
ROOT_URLCONF = 'YangFuDjango.urls'
...
WSGI_APPLICATION = 'YangFuDjango.wsgi.application'
LOGIN_URL='login'
...
# 指定應用程式的目錄/posts/static為STATICFILE_DIRS
STATICFILE_DIRS=[
